// src/OnlineTournamentRegistration.js
    ...
    if (formTournamentId && formTournamentName && playerName && email && formLocation && formDate) {
      navigate('/tournament-details', { 
        state: { 
          ...
          date: formDate,
          successMessage: 'Registration successful! You have successfully registered for the online tournament.' // Added success message
        } 
      });
    } else {
